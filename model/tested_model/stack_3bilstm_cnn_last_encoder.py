...
class StackBiLSTMMaxout(nn.Module):
    def __init__(self, h_size=[64, 128, 256], v_size=10, d=300, mlp_d=600, dropout_r=0.5, max_l=60):
        ...
        self.lstm_2 = nn.LSTM(input_size=(d * 2 + (h_size[0] + h_size[1]) * 2), hidden_size=h_size[2],
                              num_layers=1, bidirectional=True)

        self.conv_f = nn.Linear(300 * 3, 600) # This is the cnn filter.
...
def train(combined_set=False):
    ...
    name = '[512,1024,2048]-3stack-bilstm+cnn-last_maxout'
...
def evaluation():
    ...
    # saved_model/06-14-01:31:38_[512,1024,2048]-3stack-bilstm+cnn-last_maxout/saved_params/e(2)_m_m(74.01935812531839)_um(74.11513425549226)
    # /home/easonnie/Projects/ssu/saved_model/06-14-01:31:38_[512,1024,2048]-3stack-bilstm+cnn-last_maxout/saved_params/e(2)_m_m(73.69332654100866)_um(74.59316517493897)
    # /home/easonnie/Projects/ssu/saved_model/06-14-01:31:38_[512,1024,2048]-3stack-bilstm+cnn-last_maxout/saved_params/e(2)_m_m(73.90728476821192)_um(74.06427990235964)

    file_path = "saved_model/06-14-01:31:38_[512,1024,2048]-3stack-bilstm+cnn-last_maxout/saved_params/e(2)_m_m(73.90728476821192)_um(74.06427990235964)"
